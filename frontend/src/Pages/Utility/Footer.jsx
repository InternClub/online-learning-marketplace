  ...
  return (
    <div className={`bg-blue-950 p-10 text-white ${isHidden ? "hidden" : ""}`}>
      <div className="flex items-center justify-center gap-10 mb-5 ">
        <h3 className="h-5 gap-4 font-bold text-4xl text-shadow-2xs text-shadow-green-500 text-pink-400 ">
          InternHub
        </h3>
        <img src="/Images/Line 10.png" alt="" />
        <p className="">
          Vertual Class <br /> for Learners
        </p>
      </div>
      <div className="flex items-center justify-center flex-col">
        <p className="text-2xl font-semibold font-sans mb-2">
        ...
        <div>
          <input
            ...
            type="email"
          />
          <button className="bg-red-600 w-20 h-8 rounded-xl  cursor-pointer ">
            Subscribe
          </button>
        </div>
      </div>
