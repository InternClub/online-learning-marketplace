...
export default function AnalyticsDashboard() {
  return (
    <div className="p-6 bg-gray-100 min-h-screen space-y-12">
      <h1 className="text-3xl font-bold text-center text-gray-800">📊 Instructor Analytics Dashboard</h1>

      {/* Course Completion Bar Chart */}
      <div className="w-full max-w-4xl mx-auto bg-white p-4 rounded shadow">
        <h2 className="text-xl font-semibold mb-4">Course Completion Overview</h2>
