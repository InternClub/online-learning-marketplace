...
const Courses = () => {
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
    ...
    {[Course1, Course2, Course3].map((img, i) => (
      ...
      >
        <img src={img} alt={`Course ${i}`} className="w-full h-40 object-cover rounded-md" />
        ...
        <div className="text-right text-sm text-gray-500">By Instructor</div>
      </div>
    ))}
  </div>
</div>
  ...
  <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-2">
    ...
    <a href="#" className="text-sm sm:text-base text-blue-600 hover:underline">See all</a>
  </div>
  ...
  <div className="flex justify-end mt-6 gap-2">
    <button className="p-2 bg-gray-200 rounded-full hover:bg-gray-300 text-xl">←</button>
    <button className="p-2 bg-gray-200 rounded-full hover:bg-gray-300 text-xl">→</button>
  </div>
</div>
      ...
      <div className="p-10 m-10">
        <div className="bg-blue-950 p-10 rounded-2xl flex items-center justify-center flex-col">
          ...
          <p className="text-gray-300 font-mono ">
            lorem ipsum dolor ipsum dolor sit amet, consectetur adipiscing elit, sed do
